...
function draw() {
    ...
    textAlign(RIGHT);
    textSize(width / 30); // 57 for each loc
    strokeWeight(0);
    ...
    locs.forEach(function (spot, ind) {
        ...
        if (ind % 2 == 1) {
            rect(width - rightPadding - (boxWidth * (ind + 1)), 0, boxWidth, boxHeight);
            fill(0);
            textAlign(CENTER);
            textSize(width / 25);
            strokeWeight(0);
            ...
            rect(width - rightPadding - (boxWidth * (ind + 1)), height - boxHeight, boxWidth, boxHeight - 1);
            fill(0);
            textAlign(CENTER);
            textSize(width / 25);
            strokeWeight(0);
